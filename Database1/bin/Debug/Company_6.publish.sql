...
GO
ALTER TABLE [dbo].[Departement] DROP CONSTRAINT [FK__Departeme__Manag__5EBF139D];
...
GO
ALTER TABLE [dbo].[Departement] ALTER COLUMN [ManagerId] INT NULL;
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Departement'))
               AND [type] IN (N'F', N'C')
