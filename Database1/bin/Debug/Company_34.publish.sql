...
GO
ALTER TABLE [dbo].[Address] ALTER COLUMN [Number] INT NULL;
...
GO
PRINT N'[dbo].[spCreateOrUpdateAdress] wird aktualisiert....';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spCreateOrUpdateAdress]';
